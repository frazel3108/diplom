<x-admin-auth-layout>
  <div
    class="bg-purple-900 absolute top-0 left-0 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 bottom-0 leading-5 h-full w-full overflow-hidden"></div>
  <div class="relative min-h-screen  sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
    <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
      <div class="self-start hidden lg:flex flex-col text-gray-300">
        <h1 class="my-3 font-semibold text-4xl">Добро пожаловать!</h1>
        <p class="pr-3 text-sm opacity-75">
          Вы находитесь на странице авторизации в административную панель
        </p>
      </div>
    </div>
    <div class="flex justify-center self-center  z-10">
      <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
        <div class="mb-7">
          <h3 class="font-semibold text-2xl text-gray-800">Вход</h3>
        </div>
        <form method="post">
          @csrf
          ...
          <div class="space-y-6">
            ...
            <div class="relative" x-data="{ show: true }">
              <label for="password" class="form-label block text-sm font-medium text-gray-700 mb-2">
                Пароль
              </label>
              <input
                id="password"
                ...
                autocomplete="on"
              >
              <div class="flex items-center mt-7 absolute inset-y-0 right-0 mr-3  text-sm leading-5">
                <svg
                  @click="show = !show"
            ...
            <x-admin.form.checkbox name="remember">
              Запомнить меня
            ...
            <div class="flex justify-center gap-5 w-full ">
              ...
              >
                <svg class="w-4 mr-2" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100"
                  xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><style>.st0 {
                            fill: #fff
                        }
                  ...
                  <g id="Layer_1"/>
                  <g id="Layer_2">
                    <path d="M50 2.5c-58.892 1.725-64.898 84.363-7.46 95h14.92c57.451-10.647 51.419-93.281-7.46-95z"
                      style="fill:#1877f2"/>
                    <path
