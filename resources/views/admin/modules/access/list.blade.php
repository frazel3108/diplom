      ...
      <div class="px-6 py-4 border-0">
        <div class="flex flex-wrap max-sm:flex-col items-center">
          <div class="flex flex-col relative w-full max-sm:mb-3 max-w-full flex-1 float-left max-sm:justify-between max-sm:flex-row-reverse">
            <div class="mt-4">
              <h3 class="font-bold text-lg text-blueGray-700">Доступы</h3>
            </div>
          </div>
        </div>
      </div>
      <div class="block w-full overflow-x-auto">
        <table class="items-center w-full bg-transparent border-collapse">
          ...
          <tr>
            ...
            <x-admin.table.th class="w-12" sort-by="key">
              Ключ
            </x-admin.table.th>
            ...
            <tr>
              <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                <div class="flex items-center">
                  <span class="ml-3 font-bold NaN"># {{ $role->id }}</span>
                </div>
              </td>
              ...
              <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                <div class="flex items-center">
                  <a
                    ...
                    href="{{ route('admin.access.show', ['role' => $role]) }}"
                  >
                    Просмотреть
                  </a>
                </div>
