      ...
      <div class="flex lg:justify-between justify-center items-center flex-wrap h-full g-6">
        ...
        <div class="lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
          <div class="flex flex-row items-center justify-center lg:justify-start">
            <p class="text-lg mb-0 mr-4">Войти с помощью</p>
            <button
              type="button"
          ...
          <div class="flex items-center my-4 before:flex-1 before:border-t before:border-gray-300 before:mt-0.5 after:flex-1 after:border-t after:border-gray-300 after:mt-0.5">
            <p class="text-center font-semibold mx-4 mb-0">Или войдите</p>
          </div>
          <form action="{{ route('lk.login') }}" method="post" class="space-y-4">
            @csrf
            <x-admin.form.input
              label="Email адресс"
              id="email"
            ...
            <div class="flex justify-between items-center mb-6">
              ...
              <a href="{{ route('lk.password.request') }}" class="text-gray-800">Забыли пароль?</a>
            </div>
